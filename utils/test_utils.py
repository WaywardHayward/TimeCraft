...
def test_model_with_dp(model, data, trainer, opt, logdir):
    ...
    for dataset in data.norm_train_dict:
        ...
        all_metrics = run_metrics(data_name=dataset, seq_len=seq_len, model_name=tmp_name, gen_data=generated_data, scale='zscore', exist_dict=all_metrics, pred_len=int(0.75*seq_len))
